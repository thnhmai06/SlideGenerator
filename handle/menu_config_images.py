...
def add_item(config_image_table: QTableWidget):
    ...
    combo_placeholder.currentTextChanged.connect(lambda: __sync_item_with_combo(item_placeholder, combo_placeholder)) # Khi chọn item khác, cập nhật item text
    ...
    combo_image.currentTextChanged.connect(lambda: __sync_item_with_combo(item_image, combo_image)) # Khi chọn item khác, cập nhật item text
