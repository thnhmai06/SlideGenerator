...
public class WorkflowTask
{
    ...
    /// </summary>
    public ConcurrentDictionary<string, WorkbookSummary> WorkbookSummaries { get; init; } = new(StringComparer.OrdinalIgnoreCase);

    /// <summary>
    ///     Presentation scan results keyed by normalized file path.
    ///     Populated by the initial parallel presentation scan loop.
    /// </summary>
    public ConcurrentDictionary<string, PresentationSummary> PresentationSummaries { get; init; } = new(StringComparer.OrdinalIgnoreCase);
