        ...
        return new SequenceNode([
            ...
            new ParallelNode([
                new ForEachNode<WorkbookIdentifier, WorkflowTask>(
                    ...
                    true,
                    new SlotGatedNode(SlotType.ScanWorkbook, new ActivityNode<ScanWorkbook>())
                ),
                new ForEachNode<PresentationIdentifier, WorkflowTask>(
                    ...
                    true,
                    new SlotGatedNode(SlotType.ScanPresentation, new ActivityNode<ScanPresentation>())
                )
            ]),
            ...
            new ForEachNode<WorksheetIdentifier, WorkflowTask>(
                ...
                true,
                new SlotGatedNode(SlotType.Worksheet, new SequenceNode([
                            ...
                            new ForEachNode<RowIdentifier, WorkflowTask>(
                                ...
                                new TryNode(new SequenceNode([
                                    ...
                                    new ForEachNode<RowTask, WorkflowTask>(
                                        ...
                                        true,
                                        new SlotGatedNode(SlotType.Download,
                                    ...
                                    new ForEachNode<RowTask, WorkflowTask>(
                                        ...
                                        ctx =>
                                        {
                                            ...
                                            var downloadRoot =
                                                Path.GetFullPath(settings.Current.Download.DownloadFolder);
                                        ...
                                        true,
                                        new SlotGatedNode(SlotType.EditImage,
