...
class Ui(QMainWindow):
    ...
    def handleUI(self):
        ...
        self.config_text_add_button.clicked.connect(
            lambda: menu_config_text.add_item(self.config_text_list)
        )
        self.config_text_remove_button.clicked.connect(
            lambda: menu_config_text.remove_item(self.config_text_list)
        )
        self.config_image_add_button.clicked.connect(
            lambda: menu_config_images.add_item(self.config_image_table)
        )
        self.config_image_remove_button.clicked.connect(
            lambda: menu_config_images.remove_item(self.config_image_table)
        )
        self.template_broswe.clicked.connect(
            lambda: menu_broswe_button.template_powerpoint_broswe(
                self.centralwidget, self.pptx_path
            )
        )
        self.csv_broswe.clicked.connect(
            lambda: menu_broswe_button.csv_broswe(self.centralwidget, self.csv_path)
        )
        self.save_broswe.clicked.connect(
            lambda: menu_broswe_button.save_path_broswe(
