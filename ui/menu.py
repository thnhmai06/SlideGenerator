...
class Ui(QMainWindow):
    ...
    def setupUi(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./assets/logo"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def setupConfigGroupBox(self):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./assets/button/add"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./assets/button/remove"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
