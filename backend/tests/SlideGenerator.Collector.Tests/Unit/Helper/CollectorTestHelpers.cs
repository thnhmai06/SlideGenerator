...
namespace SlideGenerator.Collector.Tests.Unit.Helper;

/// <summary>
///     Provides shared test infrastructure for collector unit tests, including a fake
///     <see cref="HttpMessageHandler" /> that returns controlled HTTP responses.
/// </summary>
internal static class CollectorTestHelpers
{
    /// <summary>
