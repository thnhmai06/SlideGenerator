...
The **SlideGenerator.Document** module provides a high-level abstraction over **Syncfusion.Presentation** and **Syncfusion.XlsIO**.
...
### `IShape`
A unified interface for PowerPoint shapes. Image replacements are performed by writing directly to the `ImageData` property, which handles the underlying Syncfusion representation.
