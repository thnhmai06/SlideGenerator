...
public static class Sha256Hasher
{
    ...
    public static string ComputeHashFile(string filePath, int length = MaxLength)
    {
    ...
    ///     If the input text is null or empty, a <see cref="string.Empty" /> is returned.
    /// </returns>
    public static string ComputeHash(string text, int length = MaxLength)
    {
