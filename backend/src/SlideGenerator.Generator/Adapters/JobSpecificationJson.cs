...
namespace SlideGenerator.Generator.Adapters;
...
///     <see cref="Services.JobsRepository" />). Module-local duplicate of the equivalent converters used
...
{
    /// <summary>Shared options for serializing <see cref="Models.Data.JobSpecification" />'s JSON columns.</summary>
