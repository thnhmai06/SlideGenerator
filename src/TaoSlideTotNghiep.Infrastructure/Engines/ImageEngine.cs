...
namespace TaoSlideTotNghiep.Infrastructure.Engines;

internal static class ImageEngine
{
    public static Rectangle GetRoi(Image image, RoiType roiType, Size size)
    {
        return roiType switch
        {
            RoiType.Prominent => GetProminentRoi(image, size).Roi,
            RoiType.Center => GetCenterRoi(image, size),
    ...
    /// </summary>
    public static void Crop(Image image, Rectangle roi)
    {
    ...
    private static Mat ComputeSaliency(Image image)
    {
    ...
    private static (Rectangle Roi, double SaliencyValue) GetProminentRoi(Image image, Size size)
    {
    ...
    /// </summary>
    private static Rectangle GetCenterRoi(Image image, Size size)
    {
        var point = new Point
        {
