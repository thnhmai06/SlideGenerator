...
public abstract class Presentation(string filepath, bool isEditable) : EngineModel,
    IDisposable
{
...
public sealed class DerivedPresentation : Presentation, IDerivedPresentation
{
