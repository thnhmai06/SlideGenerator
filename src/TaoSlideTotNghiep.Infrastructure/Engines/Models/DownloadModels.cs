...
/// </summary>
public abstract class DownloadTask : EngineModel,
    IDisposable
{
    ...
    protected DownloadTask(string url, string savePath)
    {
        ...
        var config = ConfigManager.Value.Download;
...
/// </summary>
public class ImageDownloadTask(string url, string savePath) : DownloadTask(url, savePath), IImageDownloadTask
{
