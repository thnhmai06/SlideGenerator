...
/// </summary>
public sealed class GenerateService : IAsyncDisposable
{
    /// <summary>
    ///     Face detector manager used to select and control detector model lifecycle.
    /// </summary>
    private readonly FaceDetectorModelManager _faceDetectorManager;
    ...
    /// <summary>
    ///     ROI options used by all ROI calculators.
    /// </summary>
    private readonly RoiOptions _roiOptions = new();
    ...
    public GenerateService(FaceDetectorModelManager faceDetectorManager, DownloadService downloadService)
    {
        _faceDetectorManager = faceDetectorManager;
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var roiFactory = new RoiFactory { Options = _roiOptions };
