...
class Ui_menu(object):
    def setupUi(self, menu):
        ...
        self.log_checkbox = QCheckBox(self.centralwidget)
        self.log_checkbox.setGeometry(QtCore.QRect(490, 760, 111, 21))
        self.log_checkbox.setObjectName("log_checkbox")
        self.log_openFolderButton = QPushButton(self.centralwidget)
        self.log_openFolderButton.setGeometry(QtCore.QRect(490, 790, 101, 23))
        self.log_openFolderButton.setObjectName("log_openFolderButton")
        ...
        self.log_openFolderButton.clicked.connect(lambda: brosweEvent.openLogFolder())
    ...
    def retranslateUi(self, menu):
        ...
        self.log_checkbox.setText(_translate("menu", "Lưu lại log tạo Slide"))
        self.log_openFolderButton.setText(_translate("menu", "Mở vị trí lưu log"))
