...
using SlideGenerator.Infrastructure.Features.Sheets.Adapters;
using SlideGenerator.Infrastructure.Features.Sheets.Exceptions;
using CoreWorkbook = SlideGenerator.Framework.Sheet.Models.Workbook;

namespace SlideGenerator.Infrastructure.Features.Sheets.Services;
