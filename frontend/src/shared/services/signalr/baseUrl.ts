...
/**
 * Normalize a backend URL by trimming, enforcing a scheme,
 * mapping localhost to 127.0.0.1, and removing trailing slash.
 */
...
/**
 * Resolve the backend base URL, promoting a pending URL once per session.
 */
